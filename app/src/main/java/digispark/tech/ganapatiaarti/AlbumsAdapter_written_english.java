...
public class AlbumsAdapter_written_english extends RecyclerView.Adapter<AlbumsAdapter_written_english.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View itemview) {
            int a;
            a=getPosition();
            Intent intent = new Intent(itemview.getContext(), written_eng_detail_aarti.class);
    ...
    public AlbumsAdapter_written_english(List<Album> albumList) {
